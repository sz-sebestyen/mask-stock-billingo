...
function MaskOrderForm({ hospital }) {
  ...
  const postOrder = () => {
    ...
    axios({
      ...
      data: {
        ...
        partner_tax_type: hospital.tax_type === "HAS_TAX_NUMBER" ? "huf" : "eur",         //vagy "eur" - tax_type: "HAS_TAX_NUMBER" ?
  ...
  return (
    <div className="flex flex-col gap-2 p-2">
      ...
      {invoiceId && <a href={`http://localhost:3001/api/documents/download/${invoiceId}`}>download invoice</a>}
    </div>
  )
}
